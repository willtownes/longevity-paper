...
#knn via caret
system.time(fit<-train(Xtrn, ytrn, preProcess=NULL, distribution="bernoulli", verbose=FALSE, metric="Kappa", trControl=trainControl("cv",5,classProbs=TRUE), method="kknn",tuneGrid=data.frame(kmax=c(5,10,15),distance=2,kernel="optimal")))
print(fit)
