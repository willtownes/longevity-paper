...
write.table(pc2w,file="./results/auto/alg_table_worm.txt",quote=FALSE)

pc2y<-alg_ranking(subset(auc,species=="yeast"))  
write.table(pc2y,file="./results/auto/alg_table_yeast.txt",quote=FALSE)
...
```{r}
pc2<-as.matrix(read.table("./results/auto/alg_table.txt",header=TRUE))
pheatmap(pc2,display_numbers = TRUE,cluster_rows=FALSE,cluster_cols=FALSE,color = colorRampPalette(c('white','orange'))(100),fontsize = 20,angle_col=0,legend=FALSE,filename="./results/auto/plots/alg_table_heatmap.pdf")
```
