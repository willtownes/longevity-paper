...
sv$symbol<-toupper(sv$symbol)
rownames(X)<-toupper(rownames(X))
rownames(ge)<-toupper(rownames(ge))
rownames(sv)<-sv$symbol
gid<-intersect(sv$symbol,rownames(X))
gid<-sort(intersect(gid,rownames(ge)))
y<-sv[gid,"pro_longevity"]
X<-cbind(X[gid,],assay(ge,"logratio")[gid,])
